...
const Category = () => {
    return (
        <div className='my-8 grid grid-cols-1 gap-6 lg:grid-cols-3 w-[1750px] mx-auto'>
            <div>
            <div className=" group">
            <div className='max-h-125 overflow-hidden'>
                <img class="w-full h-auto transform hover:scale-110 duration-500" src="https://i.ibb.co/fSp24rk/men.webp" alt="" />
            </div>
            </div>
