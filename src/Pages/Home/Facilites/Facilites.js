...
const Facilites = () => {
    return (
        <div className='bg-gray-100 p-8'>
            <div className='my-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-[90%] mx-auto'>
            <div className='lg:lg:flex gap-2'>
            ...
            <div className='lg:lg:flex gap-2 my-3 lg:my-0'>
            ...
            <div className='lg:flex gap-2 mt-3 lg:mt-0'>
