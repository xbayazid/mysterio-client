    ...
    return (
        <div className="h-full bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-16 px-4">
            <div className="flex flex-col items-center justify-center">
                ...
                <h1 className='font-bold text-3xl'>Mysterio</h1>
                <p className='leading-10'>Don't loose hope we are always with you.</p>
                </div>
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-9">
