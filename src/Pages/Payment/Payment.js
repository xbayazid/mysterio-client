        ...
        <div>
            <div className="py-12">
                <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                    <h1 className='text-3xl font-semibold'>Payment Section</h1>
                    <div className="relative py-8 px-5 md:px-10 bg-white  rounded ">
                        ...
                        <div className="flex items-center justify-start w-full">
                            <button className="focus:outline-none transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm" onClick={()=>setShow(!show)}>Submit</button>
            ...
            {show &&  <div className="py-12 bg-gray-200 dark:bg-gray-900 transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modal">
                    <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                        <div className="relative py-8 px-8 md:px-16 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-md rounded border border-gray-400">
                            ...
                            <div className="flex items-center justify-center w-full">
                                <button className="focus:outline-none transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-4 sm:px-8 py-2 text-xs sm:text-sm" onClick={()=>setShow(!show)} >Okay</button>
                            </div>
